...
namespace System.Windows.Forms
{
    public class ToggleButton : CheckBox
    {
        ...
        public ToggleButton()
        {
            this.MinimumSize = new Drawing.Size(45, 22);
        }
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            else // OFF
            {
                ...
                else pevent.Graphics.DrawPath(new Pen(offBackColor, 2), GetFigurePath()); // Draw the toggle
                pevent.Graphics.FillEllipse(new SolidBrush(offToggleColor), new Rectangle(2 + 1, 2, toggleSize, toggleSize));
            }
        }
    }
}